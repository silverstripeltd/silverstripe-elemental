...
var _MoveAction = __webpack_require__("./client/src/components/ElementActions/MoveAction.js");
...
exports.default = function () {
  ...
  _Injector2.default.transform('element-actions', function (updater) {
    ...
    updater.component('ElementActions', _MoveAction2.default, 'ElementActionsWithMove');
...
var _moveBlockMutation = __webpack_require__("./client/src/state/editor/moveBlockMutation.js");

var _moveBlockMutation2 = _interopRequireDefault(_moveBlockMutation);
...
var MoveAction = function MoveAction(MenuComponent) {
  return function (props) {
    ...
    var disabled = props.element.canCreate !== undefined && !props.element.canCreate;
    var label = _i18n2.default._t('ElementMoveAction.MOVE', 'Move');
    var title = disabled ? _i18n2.default._t('ElementMoveAction.MOVE_PERMISSION_DENY', 'Move, insufficient permissions') : label;
    var newProps = {
      label: label,
      title: title,
      disabled: disabled,
    ...
    var modalSchemaUrl = (0, _elementConfig.getConfig)().form.elementForm.moveModalSchemaUrl + '/' + id;
    ...
    return _react2.default.createElement(
      ...
      props.children,
      _react2.default.createElement(_AbstractAction2.default, newProps),
      _react2.default.createElement(FormBuilderModal, {
        title: 'Move block to',
...
exports.default = (0, _redux.compose)(_moveBlockMutation2.default, MoveAction);
...
/***/ "./client/src/state/editor/moveBlockMutation.js":
/***/ (function(module, exports, __webpack_require__) {
